...
trait HashJoin {
  /**
    ...
    * @tparam K type of keys in hash table
    */
  def innerJoin[L, R, J, K](left: Traversable[L], right: Traversable[R])(implicit lKey: HashJoinKey[L, K], rKey: HashJoinKey[R, K], c: InnerJoinCombinator[L, R, J]): Traversable[J] = {
  ...
  /**
    ...
    * @tparam K type of keys in hash table
    */
  def innerJoin[L, R, J, K](left: Traversable[L], right: Traversable[R], lKey: (L => K), rKey: (R => K), c: ((L, R) => J)): Traversable[J]
}
...
/**
  ...
  */
trait ByLeftHashJoin extends HashJoin {
  override def innerJoin[L, R, J, K](left: Traversable[L], right: Traversable[R], lKey: (L => K), rKey: (R => K), c: ((L, R) => J)): Traversable[J] = {
...
/**
  ...
  */
trait ByRightHashJoin extends HashJoin {
  override def innerJoin[L, R, J, K](left: Traversable[L], right: Traversable[R], lKey: (L => K), rKey: (R => K), c: ((L, R) => J)): Traversable[J] = {
    val result = new ArrayBuffer[J](Math.min(left.size, right.size))
...
trait NestedLoopJoin {
  /**
    ...
    * @tparam J type of elements in collection with inner join results
    */
  def innerJoin[L, R, J](left: Traversable[L], right: Traversable[R])(implicit jp: JoinPredicate[L, R], c: InnerJoinCombinator[L, R, J]): Traversable[J] = {
  ...
  /**
    ...
    * @tparam J type of elements in collection with inner join results
    */
  def innerJoin[L, R, J](left: Traversable[L], right: Traversable[R], jp: ((L, R) => Boolean), c: ((L, R) => J)): Traversable[J]
  ...
  /**
    ...
    * @tparam J type of elements in collection with left outer join results
    */
  def leftOuterJoin[L, R, J](left: Traversable[L], right: Traversable[R])(implicit jp: JoinPredicate[L, R], c: LeftOuterJoinCombinator[L, R, J]): Traversable[J] = {
  ...
  /**
    ...
    * @tparam J type of elements in collection with left outer join results
    */
  def leftOuterJoin[L, R, J](left: Traversable[L], right: Traversable[R], jp: ((L, R) => Boolean), c: ((L, Option[R]) => J)): Traversable[J]
}

/**
  * Default implementation of hash nested loop join
  */
trait RegularNestedLoopJoin extends NestedLoopJoin {

  override def leftOuterJoin[L, R, J](left: Traversable[L], right: Traversable[R], jp: ((L, R) => Boolean), c: ((L, Option[R]) => J)): Traversable[J] = {
    val result = new ArrayBuffer[J](Math.min(left.size, right.size))
    left.seq.foreach { l =>
  ...
  override def innerJoin[L, R, J](left: Traversable[L], right: Traversable[R], jp: ((L, R) => Boolean), c: ((L, R) => J)): Traversable[J] = {
    val result = new ArrayBuffer[J](Math.min(left.size, right.size))
    left.seq.foreach { l =>
      right.seq.foreach { r =>
        if (jp(l, r)) {
...
/**
  ...
  */
trait ParallelNestedLoopJoin extends NestedLoopJoin {
  override def leftOuterJoin[L, R, J](left: Traversable[L], right: Traversable[R], jp: ((L, R) => Boolean), c: ((L, Option[R]) => J)): Traversable[J] = {
    val zero = Vector[J]()
...
/**
  ...
  * }}}
  */
final class NestedLoopInnerJoinUnary[L, R, J](lr: (Traversable[L], Traversable[R]), jp: JoinPredicate[L, R], jc: InnerJoinCombinator[L, R, J], i: NestedLoopJoin) {
  def innerJoin: Traversable[J] = i.innerJoin[L, R, J](lr._1, lr._2)(jp, jc)
}
...
final class NestedLoopJoinBinary[L, R, J](l: Traversable[L]) {
  def innerJoin(r: Traversable[R])(implicit jp: JoinPredicate[L, R], jc: InnerJoinCombinator[L, R, J], i: NestedLoopJoin): Traversable[J] = i.innerJoin[L, R, J](l, r)(jp, jc)

  def leftOuterJoin(r: Traversable[R])(implicit jp: JoinPredicate[L, R], jc: LeftOuterJoinCombinator[L, R, J], i: NestedLoopJoin): Traversable[J] = i.leftOuterJoin[L, R, J](l, r)(jp, jc)
}
...
trait ToNestedLoopInnerJoinOps {
  implicit def toInnerJoinUnary[L, R, J](lr: (Traversable[L], Traversable[R]))(implicit jp: JoinPredicate[L, R], jc: InnerJoinCombinator[L, R, J], i: NestedLoopJoin) = new NestedLoopInnerJoinUnary(lr, jp, jc, i)
...
/**
  ...
  * }}}
  */
final class HashInnerJoinUnary[L, R, J, K](lr: (Traversable[L], Traversable[R]), lKey: HashJoinKey[L, K], rKey: HashJoinKey[R, K], jc: InnerJoinCombinator[L, R, J], i: HashJoin) {
  def innerJoin: Traversable[J] = {
    i.innerJoin(lr._1, lr._2)(lKey, rKey, jc)
  }
}
...
final class HashInnerJoinBinary[L, R, J, K](l: Traversable[L]) {
  def innerJoin(r: Traversable[R])(implicit lKey: HashJoinKey[L, K], rKey: HashJoinKey[R, K], jc: InnerJoinCombinator[L, R, J], i: HashJoin): Traversable[J] = {
    i.innerJoin(l, r)(lKey, rKey, jc)
  }
}
...
trait ToHashInnerJoinOps {
  implicit def toInnerJoinUnary[L, R, J, K](lr: (Traversable[L], Traversable[R]))(implicit lKey: HashJoinKey[L, K], rKey: HashJoinKey[R, K], jc: InnerJoinCombinator[L, R, J], i: HashJoin) = new HashInnerJoinUnary(lr, lKey, rKey, jc, i)
